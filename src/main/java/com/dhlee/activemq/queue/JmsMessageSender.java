	...
	@Autowired
	 ...
	 private static int index = 0;
	  ...
	  public void send(final String text) {
		  ...
		  System.out.println("getDeliveryMode=" + this.jmsTemplate.getDeliveryMode());
	    ...
	    this.jmsTemplate.send(new MessageCreator() {
	      ...
	      public Message createMessage(Session session) throws JMSException {
	        ...
	        message.setJMSReplyTo(new ActiveMQQueue("ResponseQ"));
	        message.setJMSCorrelationID("send-" + index++);
	        return message;
	      }
	    });
	  }
